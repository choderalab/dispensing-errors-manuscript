...
To illustrate these techniques, we review an example of how choice of dispensing technology can impact assay measurements, and show how the primary contributions to discrepancies between assays can be easily understood and potentially corrected for.
...
This assay is just one example of what can be done for a large class of assays if this model is pursued for other types of experiments relevant to computational modelers.
...
For example, in our own laboratory, it has informed the decision to use only direct dispensing technologies for our fluorescent ligand-binding assays.
...
SE acknowledges Joe Olechno and Antony Williams for extensive discussions on the topic, as well as the many scientists that responded to the various blog posts.
