...
For the LabCyte Echo used in the EphB4 assay, the smallest volume dispensed is 2.5 nL droplets; other instruments such as the HP D300/D300e can dispense quantities as small as 11 pL.
...
This dilution effect also must be incorporated into the transfer of the diluted compound solutions into the enzyme assay mix, further adding to the overall bias of the assay results from the fixed-tips instrument. 
...
Examining the inaccuracy and imprecision in the dilution series or final assay solutions (Fig.~\ref{fig:volumes-n-concentrations}) and measured $p$IC$_{50}$s (Fig.~\ref{fig:acoustic-vs-tips}) for each dispensing technology can prove highly valuable.
...
While not sufficient to explain the entirety of the discrepancy, this effect could be a significant contribution to the discrepancy
