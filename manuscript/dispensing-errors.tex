...
\begin{figure}[tb]
  ...
  Since the bias is relatively sensitive to pIC50 value, here it is determined by including both the experimental value and the estimated bias.
  ...
  While this does not entirely explain all discrepancies between the two sets of data, it shifts the root mean square error between the tip-based and acoustic-based dispensing methods from 1.56 to 1.38 pIC50 units.
...
\subfloat[Zoom of pIC50 data with bias as a function of wells plotted.]{%
  ...
  Because the dilution bias is greater for lower compound concentrations, this effect is more drastic for compounds with high affinity.
  (b) Applying these biases to the pIC50 from the sample dataset shows the bias increases with both the 16 (green) and 32 (blue) well dilution series, shifting the points even further toward the line of ideal equivalence of the two types of liquid handling. 
  Note these points overlap exactly.
  }
  \label{fig:bias_vs_nwells}
\end{figure}
...
While this effect may explain a substantial component of the divergence between assay technologies, there is no doubt a significant discrepancy remains.
