...
v_{\mathrm{buffer},n} &\sim& \mathcal{N}(v_\mathrm{buffer}, \sigma_\mathrm{stock}^2) \nonumber \\
...
The EphB4 assay we will model~\cite{ekins_dispensing_2013,barlaam_novel_2009,barlaam_pyrimidine_2010} measures the accumulation of phosphorylated substrate in the presence of different inhibitor concentrations in the presence of substrate.
...
As we shall see, we use the same bootstrap scheme to model this true inhibitor concentration and how it relates to the concentration we \emph{indended} to end up in the assay well.
