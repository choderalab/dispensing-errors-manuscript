...
While here we have illustrated the importance of modeling to the specific case of liquid handling with fixed tips in the context of measuring IC$_{50}$ values for EphB4 inhibitors, there are still large discrepancies that have not been explained, and many variations on this theme, both in terms of errors in this specific experiment and different experiments to which this method of studying experimental error can be applied.
